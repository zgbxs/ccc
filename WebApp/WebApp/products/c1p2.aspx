<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="c1p2.aspx.cs" Inherits="WebApp.products.c1p2" %>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="pro-module">
                                                    <ul class="basic">
                                                        ...
                                                        <li class="code">
                                                            <span>粘度：</span>
                                                            3.3（Schilonamn011-98）</li>
                                                        <li class="code">
                                                            <span>针入度：</span>
                                                           0.1mm：16（ASTMD1321（25°））
                                                        </li>
                                                        <li class="skim">
                                                            <span>用途：</span>
                                                           制造蜡烛、蜡笔、包装用纸、文教用品、一般电讯材料及木材加工、轻化、化工原料等
                                                        </li>
                                                    </ul>
                                                   <%-- <ul class="choose">
                                                    </ul>
