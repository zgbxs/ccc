<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="c6p1.aspx.cs" Inherits="WebApp.products.c6p1" %>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="pro-module">
                                                    <ul class="basic">
                                                        ...
                                                        <li class="skim">
                                                            <span>用途：</span>
                                                           用于油漆、涂料、聚氯乙烯电缆料、 PVC 地板料、软硬管、压延板材、人革制品，鞋制品、氯化橡胶制品的增塑剂、增量剂、也可用于醇酸树脂，防水防火材料、润滑油增稠剂，石油制品的抗凝剂等领域。
                                                        </li>
                                                    </ul>
                                                   <%-- <ul class="choose">
                                                    </ul>
