<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="c1p4.aspx.cs" Inherits="WebApp.products.c1p4" %>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="pro-module">
                                                    <ul class="basic">
                                                        ...
                                                        <li class="code">
                                                            <span>粘度：</span>
                                                            4-6（Schilonamn011-98）</li>
                                                        <li class="code">
                                                            <span>针入度：</span>
                                                           0.1mm：10-16 （ASTMD1321（25°））
                                                        </li>
                                                        <li class="skim">
                                                            <span>用途：</span>
                                                           光蜡，热熔胶，建材，食品，医药，装饰等领域
                                                        </li>
                                                    </ul>
                                                   <%-- <ul class="choose">
                                                    </ul>
