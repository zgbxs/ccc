<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="c1p6.aspx.cs" Inherits="WebApp.products.c1p6" %>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="pro-module">
                                                    <ul class="basic">
                                                        ...
                                                        <li class="code">
                                                            <span>滴点：</span>
                                                            103-107（ASTMD3954）</li>
                                                        <li class="code">
                                                            <span>粘度：</span>
                                                            10（Schilonamn011-98）</li>
                                                        <li class="code">
                                                            <span>针入度：</span>
                                                           0.1mm：1（ASTMD1321（25°））
                                                        </li>
                                                        <li class="skim">
                                                            <span>用途：</span>
                                                           热熔胶，塑料，化妆品
